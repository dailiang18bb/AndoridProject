...
import java.util.List;
    ...
    /*
    * 1. store the add fact data.[string array]
    * 2. define the single row for the ListView in animal_disp.xml
    *
    *
    *  getView()
    *
...
public class MainActivity extends AppCompatActivity {
    ...
    private void configureListView() {
        ...
        exampleObjects.add(new ExampleObject(Color.BLACK, "Name 6"));
        exampleObjects.add(new ExampleObject(Color.CYAN, "Name 7"));
        exampleObjects.add(new ExampleObject(Color.LTGRAY, "Name 8"));
        exampleObjects.add(new ExampleObject(Color.DKGRAY, "Name 9"));
        exampleObjects.add(new ExampleObject(Color.MAGENTA, "Name 10"));
